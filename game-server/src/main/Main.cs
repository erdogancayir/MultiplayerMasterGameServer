...
namespace GameServer
{
    public class Program
    {
        ...
        private static void StartGameServer()
        {
            ...
            var socketListener = new SocketListener(serverConfig.SocketTcpListenerPort, serviceProvider);
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<UdpClient>(provider => 
            {
                var serverConfig = provider.GetRequiredService<ServerConfig>();
                Console.WriteLine($"UDP listenerstarted on port: {serverConfig.SocketUdpListenerPort}");
                return new UdpClient(serverConfig.SocketUdpListenerPort);
            });
            services.AddSingleton<UdpConnectionHandler>();
